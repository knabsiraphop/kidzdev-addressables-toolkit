...
```
https://github.com/knabsiraphop/addressables-toolkit.git#v1.0.0
```
...
{
  "dependencies": {
    "com.kidzdev.addressables-toolkit": "https://github.com/knabsiraphop/addressables-toolkit.git#v1.0.0"
  }
}
```
